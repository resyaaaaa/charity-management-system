...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="#" class="bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-lg hover:bg-white/30 transition">Add Donor</a>
</div>
    ...
    <table class="min-w-full divide-y divide-white/20 text-gray-200">
        ...
        <tbody class="divide-y divide-white/10">
            ...
            <tr class="hover:bg-white/10 transition">
                ...
                <td class="px-6 py-4">donor{{ $i+1 }}@example.com</td>
                <td class="px-6 py-4">012-345678{{ $i }}</td>
