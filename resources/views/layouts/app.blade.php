    ...
    <div class="flex h-screen bg-black/40 backdrop-blur-sm">
        ...
        <aside class="w-64 bg-black/30 backdrop-blur-md text-white hidden md:block shadow-lg">
            ...
            <nav class="mt-6 space-y-2">
                <a href="{{ url('/dashboard') }}" class="block px-6 py-3 rounded-lg hover:bg-white/10 transition backdrop-blur-sm">Dashboard</a>
                <a href="{{ url('/donors') }}" class="block px-6 py-3 rounded-lg hover:bg-white/10 transition backdrop-blur-sm">Donors</a>
